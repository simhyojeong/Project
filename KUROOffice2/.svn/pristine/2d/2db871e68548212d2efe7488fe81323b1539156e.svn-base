...
<div class="email-app">
	<div class="left-part" style="width: 200px; background-color: #D2E0F5;">
		...
		<div class="scrollable" style="height: 100%">
			...
			<a href="/hjupload/거래처목록.jpg" download="hjung.jpg">다운로드 </a>
				...
				<div class="bootstrap-duallistbox-container row moveonselect">
					<div class="box1 col-md-6">
						...
						<select multiple="multiple"
							...
							name="_helper1" style="height: 101.333px; background-color: #F0F8FF;">
					...
					<div class="box2 col-md-6">
						...
						<select multiple="multiple"
							...
							name="_helper2" style="height: 101.333px; background-color: #F0F8FF;">
						</select>
					</div>
				</div>
			</div>
