					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="file_export"
								...
								style="border: 2px solid #9ea7ad82;">
								<thead>
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="list-group mt-4">
						...
						<a href="/contact/list" class="list-group-item contact" style="border-color: #adabab;"><i
					...
					<div class="list-group" style="border-color: #adabab;">
