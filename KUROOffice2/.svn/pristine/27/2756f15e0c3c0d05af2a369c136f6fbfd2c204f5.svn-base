          ...
          <div class="row">
       	...
       	<table id="file_export" class="table table-bordered nowrap display dataTable no-footer" role="grid" aria-describedby="file_export_info">
                     <thead>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="file_export" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 0px;"></th>
                        </tr>
                      </thead>
                      <tbody>
                      ...
                      <tr role="row" class="odd">
                          ...
                          <td class="sorting_1">
                            <span class="badge bg-light-danger text-danger font-weight-medium">${contact.conEmail }</span>
                          </td>
